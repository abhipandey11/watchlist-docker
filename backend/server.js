...
if(req.body.type==="Movie" || req.body.type==="Drama"){
...
const response=await axios.get(
`https://www.googleapis.com/books/v1/volumes?q=${req.body.title}`
);

poster=response.data.items?.[0]?.volumeInfo?.imageLinks?.thumbnail || "";
